...
export const AutoFlowAnalyzing: React.FC<AutoFlowAnalyzingProps> = ({
  total,
  processed,
}) => {
  ...
  return (
    <div
      style={{
        ...
        inset: 0,
        zIndex: 90,
        background: 'rgba(var(--af-bg-rgb),0.92)',
    ...
    >
      ...
      <div style={{ width: 290 }}>
        ...
        >
          ...
          <span
            style={{ fontSize: 12, color: 'var(--af-review)', fontWeight: 700 }}
          >
            {progress}%
          </span>
        </div>
        ...
        >
          <div
            style={{
              ...
              background:
                'linear-gradient(90deg, var(--af-review), var(--af-reject))',
            }}
          />
        </div>
      </div>
