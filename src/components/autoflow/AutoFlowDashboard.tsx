    ...
    >
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <span
            style={{ fontSize: 14, fontWeight: 700, color: 'var(--af-t1)' }}
          >
            {title}
          </span>
        </div>
        {confidence != null && (
          <div
            style={{
              ...
              fontSize: 11,
              fontWeight: 600,
              background: 'rgba(var(--af-overlay-rgb),0.06)',
              color: 'var(--af-t2)',
            }}
          >
            Conf. {confidence}%
      ...
      <div style={{ display: 'flex', gap: 3, flexWrap: 'wrap', minHeight: 30 }}>
        {photos.length > 0 ? (
          photos
            .slice(0, 9)
            .map((p) => <MiniPh key={p.id} photo={p} size={46} />)
        ) : (
          <span
            style={{
              fontSize: 12,
          ...
          style={{
            ...
            border: `2px solid ${
              p.isPick
                ...
                : p.isRejected
                  ? 'rgba(var(--af-reject-rgb),0.4)'
                  : 'rgba(var(--af-overlay-rgb),0.07)'
            }`,
            opacity: p.isRejected ? 0.32 : 1,
        ...
        >
          <div
            style={{
              ...
              fontWeight: 800,
              lineHeight: 1.3,
              color: 'rgba(var(--af-overlay-rgb),0.75)',
    ...
    return (
      <div
        style={{
          ...
          padding: '10px 16px',
          borderRadius: 9,
          background: 'rgba(var(--af-pick-rgb),0.08)',
          border: '1px solid rgba(var(--af-pick-rgb),0.2)',
        }}
      >
        <div
          style={{
          ...
          >
            <div
              style={{
                ...
                borderRadius: 3,
                background:
                  'linear-gradient(90deg, var(--af-pick), var(--af-pick))',
    ...
    return (
      <div
        style={{
          ...
          padding: '10px 0',
          borderRadius: 9,
          background: 'rgba(var(--af-pick-rgb),0.1)',
          border: '1px solid rgba(var(--af-pick-rgb),0.3)',
          color: 'var(--af-pick)',
          fontSize: 13,
          fontWeight: 700,
        }}
    ...
    return (
      <div
        style={{
          ...
          padding: '10px 0',
          borderRadius: 9,
          background: 'rgba(var(--af-reject-rgb),0.08)',
          border: '1px solid rgba(var(--af-reject-rgb),0.2)',
          color: 'var(--af-reject)',
          fontSize: 12,
          fontWeight: 600,
        }}
  ...
  return (
    ...
    >
      ...
      <svg
        ...
        viewBox="0 0 24 24"
        fill="none"
        stroke="rgba(var(--af-pick-rgb),0.5)"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
      >
    ...
    >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          <div
            style={{
              ...
              borderRadius: 9,
              background:
                'linear-gradient(135deg, var(--af-review), var(--af-reject))',
              display: 'flex',
              alignItems: 'center',
              justifyContent: 'center',
              flexShrink: 0,
          ...
          {[
            {
              ...
              col: 'rgba(var(--af-overlay-rgb),0.5)',
            },
        ...
        <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
            ...
            (onExportPicks ? (
              <button
                ...
                style={{
                  ...
                  outline: 'none',
                  background:
                    'linear-gradient(135deg, rgba(var(--af-pick-rgb),0.16), rgba(var(--af-pick-rgb),0.08))',
          ...
          <button
            ...
            style={{
              ...
              fontWeight: 600,
              cursor: 'pointer',
              border: '1px solid rgba(var(--af-overlay-rgb),0.12)',
              background: 'rgba(var(--af-overlay-rgb),0.05)',
              color: 'var(--af-t2)',
              outline: 'none',
            }}
        ...
        >
          <div
            style={{
              ...
              height: 8,
              borderRadius: '50%',
              background: 'var(--af-pick)',
              boxShadow: '0 0 10px var(--af-pick)',
      ...
      >
        ...
        <PileCard
          ...
          primaryLabel={
            reviews.length > 0 ? 'Mode Swipe ->' : 'Reviser tout ->'
          }
      ...
      <div
        style={{
          margin: '14px 28px 0',
          display: 'flex',
          background: 'rgba(var(--af-overlay-rgb),0.02)',
          border: '1px solid rgba(var(--af-overlay-rgb),0.05)',
          borderRadius: 12,
          overflow: 'hidden',
        }}
      >
        {[
          ...
          },
          {
            ...
            val: photos.filter((p) => p.isDup).length,
            col: 'rgba(var(--af-overlay-rgb),0.55)',
            action: onDupCompare,
          },
          {
            label: 'Photos floues',
            val: photos.filter((p) => p.isBlurry).length,
            col: 'rgba(var(--af-overlay-rgb),0.55)',
            action: undefined,
          },
          {
            label: 'Picks automatiques',
            val: keeps.length,
            col: 'rgba(var(--af-overlay-rgb),0.55)',
            action: undefined,
          },
