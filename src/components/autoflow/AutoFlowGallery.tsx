  ...
  return (
    <svg width={size} height={size} viewBox={`0 0 ${size} ${size}`}>
      <circle
        ...
        r={r}
        fill="none"
        stroke="rgba(var(--af-overlay-rgb),0.04)"
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span style={{ fontSize: 14, fontWeight: 700, color: 'var(--af-t2)' }}>
          {title}
        </span>
      ...
      <div style={{ flex: 1, display: 'flex', overflow: 'hidden' }}>
            ...
            return (
              <div
                ...
                style={{
                  ...
                  boxShadow: isSel
                    ? '0 0 0 2px rgba(var(--af-review-rgb),0.2)'
                    : 'none',
                  opacity: p.isRejected ? 0.38 : 1,
                  transition: 'all 0.1s',
                }}
              >
                <div
        ...
        {selected && (
          <div
            style={{
              width: 240,
              borderLeft: '1px solid rgba(var(--af-overlay-rgb),0.05)',
              background: 'var(--af-s1)',
              padding: 14,
              display: 'flex',
              flexDirection: 'column',
          ...
          >
            ...
            <div style={{ display: 'flex', gap: 6 }}>
              <button
                ...
                style={{
                  ...
                  border: 'none',
                  outline: 'none',
                  background: selected.isPick
                    ? 'var(--af-pick)'
                    : 'rgba(16,185,129,0.1)',
                  color: selected.isPick ? '#000' : 'var(--af-pick)',
                }}
              >
                {selected.isPick ? '✓ Pick' : 'Pick'}
              </button>
              <button
                onClick={() =>
                  upd(selected.id, {
                    isRejected: !selected.isRejected,
                    isPick: false,
                  })
                }
                style={{
                  ...
                  border: 'none',
                  outline: 'none',
                  background: selected.isRejected
                    ? 'var(--af-reject)'
                    : 'rgba(244,63,94,0.1)',
                  color: selected.isRejected ? '#000' : 'var(--af-reject)',
                }}
              >
                {selected.isRejected ? '✓ Rejete' : 'Rejeter'}
              </button>
            </div>
            ...
            {selected.suggestion && (
              <div
                style={{
                  padding: 8,
                  background: 'rgba(var(--af-review-rgb),0.05)',
                  border: '1px solid rgba(var(--af-review-rgb),0.1)',
                  borderRadius: 7,
                }}
              >
                <div
