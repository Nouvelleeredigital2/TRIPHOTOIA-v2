...
export const AutoFlowImportScreen: React.FC<AutoFlowImportScreenProps> = ({
  ...
  return (
    <div style={{
      ...
      {/* Hidden file input */}
      <input
        ref={inputRef} type="file" multiple accept="image/*,.raw,.cr2,.nef,.dng,.arw,.raf,.rw2"
        style={{ display: 'none' }}
      ...
      <div style={{ textAlign: 'center', maxWidth: 520 }}>
        <div style={{
          ...
          color: 'var(--af-review)', textTransform: 'uppercase', marginBottom: 12,
        }}>AutoFlow — Nouveau workflow</div>
        <h2 style={{
          fontSize: 32, fontWeight: 800, letterSpacing: '-0.03em',
          lineHeight: 1.1, marginBottom: 12,
          color: 'var(--af-t1)', margin: '0 0 12px',
        }}>
          Triez 500 photos en{' '}
          <span style={{
            color: 'var(--af-pick)',
        ...
        <p style={{ fontSize: 15, color: 'var(--af-t3)', lineHeight: 1.65, margin: 0 }}>
          L'IA classe automatiquement chaque photo. Vous ne révisez que les cas incertains — en mode Swipe ultra-rapide.
        </p>
      </div>
      ...
      >
        ...
        <div style={{
          ...
          <svg width={24} height={24} viewBox="0 0 24 24"
            fill="none" stroke="var(--af-review)" strokeWidth="1.8"
